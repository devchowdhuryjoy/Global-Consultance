...
const StudyInEurope = () => {
  ...
  const reasons = [
    ...
    },
    {
      title: "600,000+",
      description:
        "International students opting for higher studies in the Europe (20% rise from 2021)",
      bg: "bg-blue-100",
      emoji: "🎓",
    },
    {
      title: "500,000 + Visas",
      description:
        "In June 2023, the Europe granted nearly 500,000 sponsored study visas (23% increase from 2022)",
      bg: "bg-rose-100",
      emoji: "🛂",
    },
    {
      ...
      description:
        "Europe degrees and qualifications are recognized and respected internationally.",
      bg: "bg-green-100",
      emoji: "🌍",
    },
    {
      ...
      description:
        "International students in the Europe are allowed to work part-time up to 20 hours per week while studying, and full-time during semester breaks.",
      bg: "bg-neutral-100",
      emoji: "⏰",
    },
  ];
  ...
  const scholarships = [
    {
      ...
      description: "Europe Government’s international scholarship",
    ...
    },
    {
      ...
      description: "For various Europe universities",
    ...
    {
      name: "Europe Alumni Scholarship",
      description: "For students with family alumni in the Europe",
  ...
  const universities = [
    {
      ...
      logo: "src/assets/Eur1.png",
    },
    {
      // name: "Canterbury Christ Church University",
      logo: "src/assets/Eur2.png",
    },
    {
      // name: "Cardiff Metropolitan University",
      logo: "src/assets/Eur3.png",
    },
    {
      // name: "De Montfort University",
      logo: "src/assets/Eur4.png",
    },
    {
      // name: "Leeds Arts University",
      logo: "src/assets/Eur5.png",
    },
    {
      // name: "University of Plymouth",
      logo: "src/assets/Eur6.png",
    },
    {
      // name: "University of Hertfordshire",
      logo: "src/assets/Eur7.png",
    },
    {
      // name: "University of Northampton",
      logo: "src/assets/Eur8.png",
    },
  ];
  //16th Section
  ...
  const faqData = [
    {
      question:
        "What are the academic and language requirements for Bangladeshi students applying to Europe universities?",
      answer:
        "The academic requirements for Bangladeshi students applying to Europe universities depend on the subjects you are applying to. For the English language requirements, you will need to take the IELTS (with a score of 6.0 to 7.5), TOEFL (with a score of 80 to 100), or PTE (with a score of 51 to 67).",
    },
    {
      question:
        "What is the cost of studying and living in the Europe for a student from Bangladesh?",
      answer: "",
    },
    {
      question:
        "What visa requirements do Bangladeshi students need to fulfill to study in the Europe?",
      answer: "",
    },
    {
      question:
        "Are there scholarships specifically available for Bangladeshi students in the Europe?",
      answer: "",
    },
    {
      question:
        "What are the post-study work opportunities for Bangladeshi students after graduation in the Europe?",
      answer: "",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Moreover, the Europe offers a post-study visa option, enabling
              ...
              making the Europe an attractive destination for those looking to
      ...
      <section className="bg-white py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#252364] mb-10 text-center">
            Top 5 Reasons <br className="md:hidden" /> to Study in the Europe
          </h2>
      ...
      <section className="bg-[#fdfafa] py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-[#252364] mb-6">
            Cost of Studying in the Europe
          </h2>
      ...
      <section className="bg-[#f9f6f6] py-12 px-4 md:px-8 lg:px-16">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#1c2c6b] mb-4">
            Admission Requirements for Studying in the Europe
          </h2>
      ...
      <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
            ...
            university admissions in the Europe are IELTS, TOEFL, and PTE—each
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        {/* Heading */}
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1c2c6b] mb-6">
          Post-Study Work Opportunities in the Europe
        </h2>
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-gray-700 text-base md:text-lg leading-relaxed space-y-4">
          ...
          <p>
            ...
            Scholarships for master’s degree applicants. The Europe Alumni
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a6f] mb-4">
            Top Universities to Study in the Europe
          </h2>

          {/* Paragraph */}
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed text-justify">
            The Europe has one of the largest selections of universities in the
            ...
            world. Additionally, the Europe features specialized universities
