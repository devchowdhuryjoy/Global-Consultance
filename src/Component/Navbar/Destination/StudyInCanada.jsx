  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-6">
              ...
              of the notable advantages of studying in the Canada is the wide
      ...
      <section className="bg-[#fdfafa] py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-700 text-base leading-relaxed mb-4">
            The costs of studying in the Canada can vary significantly, offering
            a unique opportunity to shape your journey. Choosing a vibrant city
            near the heart of the Canada may come with higher expenses, but it
      ...
      <section className="bg-white py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6 text-gray-700 text-base leading-relaxed">
            <p>
              Bangladeshi students studying in the Canada may be concerned about
              the cost of living, but with some thoughtful planning, it can be
              made manageable. The total living expenses in the Canada vary
            ...
            <p>
              Food costs in the Canada can also add up, but preparing
            ...
            <p>
              ...
              Canada with confidence and ease.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f9f6f6] py-12 px-4 md:px-8 lg:px-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
            ...
            Canada is an excellent choice. Ensure that you submit all relevant
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div>
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
            ...
            Canada student visa, you will need several key documents. First,
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-gray-700 text-base md:text-lg leading-relaxed space-y-4 mb-10">
          <p>
            Many students from Bangladesh prefer studying in the Canada because
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-6 text-gray-700 text-base sm:text-lg leading-relaxed space-y-4 text-justify">
            <p>
              ...
              study in the Canada. However, there is a growing trend for
            ...
            <p>
              ...
              which are gaining popularity. Studying in the Canada offers more
