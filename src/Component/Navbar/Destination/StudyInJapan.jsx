  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-6">
              ...
              of the notable advantages of studying in the Japan is the wide range
      ...
      <section className="bg-[#fdfafa] py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-700 text-base leading-relaxed mb-4">
            The costs of studying in the Japan can vary significantly, offering a
            unique opportunity to shape your journey. Choosing a vibrant city
            near the heart of the Japan may come with higher expenses, but it also
      ...
      <section className="bg-white py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6 text-gray-700 text-base leading-relaxed">
            <p>
              Bangladeshi students studying in the Japan may be concerned about the
              cost of living, but with some thoughtful planning, it can be made
              manageable. The total living expenses in the Japan vary based on
            ...
            <p>
              ...
              plan, you can navigate the financial landscape of living in the Japan
      ...
      <section className="bg-[#f9f6f6] py-12 px-4 md:px-8 lg:px-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
            ...
            completed a bachelor’s degree, pursuing a master’s degree in the Japan
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-gray-700 text-base md:text-lg leading-relaxed space-y-4 mb-10">
          <p>
            Many students from Bangladesh prefer studying in the Japan because the
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-6 text-gray-700 text-base sm:text-lg leading-relaxed space-y-4 text-justify">
            <p>
              ...
              study in the Japan. However, there is a growing trend for students to
            ...
            <p>
              ...
              which are gaining popularity. Studying in the Japan offers more than
