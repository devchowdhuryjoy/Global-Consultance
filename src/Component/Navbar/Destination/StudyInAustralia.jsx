...
const StudyInAustralia = () => {
  ...
  const reasons = [
    ...
    },
    {
      title: "600,000+",
      description:
        "International students opting for higher studies in the Australia (20% rise from 2021)",
      bg: "bg-blue-100",
      emoji: "🎓",
    },
    {
      title: "500,000 + Visas",
      description:
        "In June 2023, the Australia granted nearly 500,000 sponsored study visas (23% increase from 2022)",
      bg: "bg-rose-100",
      emoji: "🛂",
    },
    {
      ...
      description:
        "Australia degrees and qualifications are recognized and respected internationally.",
      bg: "bg-green-100",
      emoji: "🌍",
    },
    {
      ...
      description:
        "International students in the Australia are allowed to work part-time up to 20 hours per week while studying, and full-time during semester breaks.",
      bg: "bg-neutral-100",
      emoji: "⏰",
    },
  ];
  ...
  const scholarships = [
    {
      ...
      description: "Australia Government’s international scholarship",
    ...
    },
    {
      ...
      description: "For various Australia universities",
    ...
    {
      name: "Australia Alumni Scholarship",
      description: "For students with family alumni in the Australia",
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Moreover, the Australia offers a post-study visa option, enabling
      ...
      <section className="bg-white py-12 px-4 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#252364] mb-10 text-center">
            Top 5 Reasons <br className="md:hidden" /> to Study in the Australia
          </h2>
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        {/* Heading */}
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1c2c6b] mb-6">
          Post-Study Work Opportunities in the Australia
        </h2>
      ...
      <div className="bg-white py-12 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="text-gray-700 text-base md:text-lg leading-relaxed space-y-4">
          ...
          <p>
            ...
            Scholarships for master’s degree applicants. The Australia Alumni
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a6f] text-center">
            Top Courses to Study in the Australia
          </h2>
