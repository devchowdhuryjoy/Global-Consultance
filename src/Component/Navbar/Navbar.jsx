...
//                 <option value="Preferred Study Destination">
...
//                 <button
//                   type="submit"
//                   className="mt-6 bg-[#f16f22] hover:bg-red-600 text-white font-semibold px-6 py-2 rounded-full transition duration-300"
//                 >
//                   Submit
//                 </button>
//               </div>
...
const Navbar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.agreeTerms) {
      setMessage("You must agree to Privacy Policy and Terms & Conditions.");
      return;
    }
    ...
    try {
      const response = await fetch(
        "http://192.168.1.9:8000/api/v1/registration",
        {
          method: "POST",
          headers: {
      ...
      setShowForm(false); // Close form on success if you want
    } catch (error) {
       Swal.fire({
      title: 'Error!',
