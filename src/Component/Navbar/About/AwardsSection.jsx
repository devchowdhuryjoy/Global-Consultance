    ...
    const fetchAwards = async () => {
      try {
        ...
        const formattedAwards = data.map((item, index) => ({
          ...
          title: item.text || "",
          subtitle: item.subtitle || item.excerpt || "Award by Institution",
        }));
      ...
      <div className="w-full">
        <div className="bg-white py-12 px-4 md:px-16">
          <div className="max-w-7xl mx-auto">
            ...
            <p>No Visa Success data available</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-[#f9f9f9] py-12 px-4 md:px-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-black text-base md:text-lg mb-4 text-justify">
              Earning a multitude of esteemed awards and honors, Global Routeway
              Global stands tall in its years of remarkable operation.
            </p>
            <p className="text-black text-base md:text-lg mb-4 text-justify">
      ...
      <div className="bg-white py-12 px-4 md:px-16 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <div
              ref={prevRef}
              className="swiper-button-prev-custom absolute left-[-15px] md:left-[-50px] top-1/2 transform -translate-y-1/2 z-10 cursor-pointer bg-[#f16f22] w-10 h-10 rounded-full flex items-center justify-center  transition-colors duration-300"
            >
              <svg
            ...
            <div
              ref={nextRef}
              className="swiper-button-next-custom absolute right-[-15px] md:right-[-50px] top-1/2 transform -translate-y-1/2 z-10 cursor-pointer bg-[#f16f22] w-10 h-10 rounded-full flex items-center justify-center  transition-colors duration-300"
            >
              <svg
                className="w-5 h-5 text-white"
                fill="none"
