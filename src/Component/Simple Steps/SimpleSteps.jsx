...
const SimpleSteps = () => {
  ...
  },
  {
    ...
    description:
      "Mock interviews and personalised tips to help you shine.",
    bg: "bg-purple-400",
    icon: "🗣️",
  },
  {
     ...
     <div className="bg-white py-10 px-4 sm:px-8 md:px-16 lg:px-24">
      <div className="text-center mb-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">
          Study Abroad in just <span className="text-[#f16f22]">5 Simple Steps</span>
        </h1>
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center space-y-10 md:space-y-0">
        {steps.map((step) => (
          <div key={step.id} className="flex flex-col items-center text-center max-w-xs">
            ...
            <h3 className="font-bold text-blue-900 text-lg mb-2">{step.heading}</h3>
