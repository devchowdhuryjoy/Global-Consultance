...
//   const faqs = [
//     {
//       question: "What are the entry requirements for nursing in Australia?",
//       answer:
...
//       answer:
//         "A Bachelor of Nursing typically takes 3 years of full-time study, while a Diploma of Nursing takes 18-24 months. After completing your degree, you'll need to register with the Nursing and Midwifery Board of Australia.",
//     },
//     {
//       question:
//         "Can international students work as nurses in Australia after graduation?",
//       answer:
//         "Yes, international students can apply for a post-study work visa after completing their nursing qualification. You'll need to meet registration requirements with the Nursing and Midwifery Board of Australia to practice as a nurse.",
//     },
//     {
//       question: "What is the cost of studying nursing in Australia?",
//       answer:
...
//     {
//       question:
//         "Are there scholarships available for international nursing students?",
//       answer:
//         "Yes, many Australian universities offer scholarships for international students. These can be merit-based, need-based, or specific to certain countries or fields of study like nursing.",
//     },
//   ];
...
//             <p className="mb-4">
//               Pursue Enrolled Nursing Courses in Australia from Bangladesh, from
//               the urge of humanity & sense the spirit of rewards and individual
//               fulfillment. With the chronic population boom worldwide, the
//               demand for nursing courses and proficient nurses in the healthcare
...
//               nursing courses in Australia from Bangladesh may be the pertinent
//               path for you. A diploma in Nursing courses at any globally ranked
//               institute might allow you to kick-start your career as an enrolled
//               nurse.
//             </p>
//             <p className="mb-4">
//               You can also study Nursing for an undergraduate or postgraduate
//               degree, which will enable you to get a license and become a
//               registered nurse. Besides, considering Nursing as a career may
//               entail a journey of healthcare benefits and work-hour flexibility.
//             </p>
//             <p className="mb-4">
//               Moreover, the salary of this profession is also rising as demand
//               for Nursing services soars. To get admission into world-known
...
//                 </h3>
//                 <ul className="text-gray-700 text-base list-disc list-inside space-y-2">
//                   <li>Education: Diploma of Nursing or Class 12th</li>
...
//             <li>
//               Registered Nurse (under a specific sub-field like community
...
const Nursing = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}course-nurse-get`)
      ...
      .catch((err) => console.error("Error fetching nursing content:", err));
  }, []);
      ...
      <div className="bg-[#e6f6fc] py-12 px-4 sm:px-6 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
          ...
          <div className="order-1 lg:order-2 flex-1 relative">
            <div className="rounded-xl overflow-hidden shadow-md">
              <img
                src={`${IMAGE_BASE_URL}${nursingData.image}`}
                alt="Study in the Australia"
                className="w-full h-auto object-cover"
              />
            </div>
