...
//   const faqs = [
//     {
//       question: "What are the entry requirements for Engineering in Australia?",
//       answer:
...
//     {
//       question:
//         "How long does it take to become a registered Engineering in Australia?",
//       answer:
//         "A Bachelor of Engineering typically takes 3 years of full-time study, while a Diploma of Engineering takes 18-24 months. After completing your degree, you'll need to register with the Engineering and Midwifery Board of Australia.",
//     },
//     {
//       question:
//         "Can international students work as Engineerings in Australia after graduation?",
//       answer:
//         "Yes, international students can apply for a post-study work visa after completing their Engineering qualification. You'll need to meet registration requirements with the Engineering and Midwifery Board of Australia to practice as a Engineering.",
//     },
//     {
//       question: "What is the cost of studying Engineering in Australia?",
//       answer:
...
//     {
//       question:
//         "Are there scholarships available for international Engineering students?",
//       answer:
//         "Yes, many Australian universities offer scholarships for international students. These can be merit-based, need-based, or specific to certain countries or fields of study like Engineering.",
//     },
//   ];
...
//       {/* 2nd section - Engineering Content */}
...
//             <p className="mb-4">
//               Pursue Enrolled Engineering Courses in Australia from Bangladesh,
//               from the urge of humanity & sense the spirit of rewards and
//               individual fulfillment. With the chronic population boom
//               worldwide, the demand for Engineering courses and proficient
//               Engineerings in the healthcare system is constantly rising.
//             </p>
//             <p className="mb-4">
...
//               Engineering courses in Australia from Bangladesh may be the
//               pertinent path for you. A diploma in Engineering courses at any
//               globally ranked institute might allow you to kick-start your
//               career as an enrolled Engineering.
//             </p>
//             <p className="mb-4">
//               You can also study Engineering for an undergraduate or
//               postgraduate degree, which will enable you to get a license and
//               become a registered Engineering. Besides, considering Engineering
//               as a career may entail a journey of healthcare benefits and
//               work-hour flexibility.
//             </p>
//             <p className="mb-4">
//               Moreover, the salary of this profession is also rising as demand
//               for Engineering services soars. To get admission into world-known
...
//                 </h3>
//                 <ul className="text-gray-700 text-base list-disc list-inside space-y-2">
//                   <li>Education: Diploma of Engineering or Class 12th</li>
...
//             <li>Engineering Educator</li>
//             <li>Engineering Researcher</li>
//             <li>
//               Registered Engineering (under a specific sub-field like community
...
const Engineering = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}course-engineering-get`)
      .then((res) => res.json())
      .then((data) => {
      ...
      .catch((err) =>
        console.error("Error fetching Engineering content:", err)
      );
  }, []);
    ...
    <>
      ...
      <div className="bg-[#e6f6fc] py-12 px-4 sm:px-6 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
          ...
          <div className="order-1 lg:order-2 flex-1 relative">
            <div className="rounded-xl overflow-hidden shadow-md">
              <img
                src={`${IMAGE_BASE_URL}${EngineeringData.image}`}
                alt="Study in the Australia"
                className="w-full h-auto object-cover"
              />
            </div>
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          {/* <div className="prose max-w-none text-gray-700">
            <p className="mb-4 whitespace-pre-line">{EngineeringData.content}</p>
          </div> */}
          <div
            className="prose prose-li:marker:text-black prose-ol:pl-5 prose-ul:pl-5 max-w-none text-gray-800"
            dangerouslySetInnerHTML={{ __html: EngineeringData.content }}
          ></div>
        </div>
      </div>
