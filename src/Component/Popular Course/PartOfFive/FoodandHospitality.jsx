...
const FoodandHospitality = () => {
  ...
  const [FoodandHospitalityData, setFoodandHospitalityData] = useState({
    text: "",
    image: "",
    content: "",
  });
  ...
  useEffect(() => {
    fetch(`${BASE_URL}course-food-hospitality-get`)
      .then((res) => res.json())
      .then((data) => {
        if (data && data.length > 0) {
          setFoodandHospitalityData({
            text: data[0].text,
            image: data[0].image,
      ...
      .catch((err) =>
        console.error("Error fetching FoodandHospitality content:", err)
      );
  }, []);
  ...
  const faqs = [
    {
      question:
        "What are the entry requirements for FoodandHospitality in Australia?",
      answer:
    ...
    {
      question:
        "How long does it take to become a registered food-hospitality in Australia?",
      answer:
        "A Bachelor of FoodandHospitality typically takes 3 years of full-time study, while a Diploma of FoodandHospitality takes 18-24 months. After completing your degree, you'll need to register with the FoodandHospitality and Midwifery Board of Australia.",
    },
    {
      question:
        "Can international students work as food-hospitalitys in Australia after graduation?",
      answer:
        "Yes, international students can apply for a post-study work visa after completing their FoodandHospitality qualification. You'll need to meet registration requirements with the FoodandHospitality and Midwifery Board of Australia to practice as a food-hospitality.",
    },
    {
      question: "What is the cost of studying FoodandHospitality in Australia?",
      answer:
    ...
    {
      question:
        "Are there scholarships available for international FoodandHospitality students?",
      answer:
        "Yes, many Australian universities offer scholarships for international students. These can be merit-based, need-based, or specific to certain countries or fields of study like FoodandHospitality.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
          ...
          <div className="order-1 lg:order-2 flex-1 relative">
            <div className="rounded-xl overflow-hidden shadow-md">
              <img
                src={`${IMAGE_BASE_URL}${FoodandHospitalityData.image}`}
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          {/* <div className="prose max-w-none text-gray-700">
            <p className="mb-4 whitespace-pre-line">{FoodandHospitalityData.content}</p>
          </div> */}
          <div
            className="prose prose-li:marker:text-black prose-ol:pl-5 prose-ul:pl-5 max-w-none text-gray-800"
            dangerouslySetInnerHTML={{ __html: FoodandHospitalityData.content }}
          ></div>
        </div>
      </div>
