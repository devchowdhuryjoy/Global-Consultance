...
const FoodandHospitality = () => {
  ...
  const faqs = [
    {
      question:
        "What are the entry requirements for Food and Hospitality in Australia?",
      answer:
    ...
    {
      question:
        "How long does it take to become a registered Food and Hospitality in Australia?",
      answer:
        "A Bachelor of Food and Hospitality typically takes 3 years of full-time study, while a Diploma of Food and Hospitality takes 18-24 months. After completing your degree, you'll need to register with the Food and Hospitality and Midwifery Board of Australia.",
    },
    {
      question:
        "Can international students work as Food and Hospitalitys in Australia after graduation?",
      answer:
        "Yes, international students can apply for a post-study work visa after completing their Food and Hospitality qualification. You'll need to meet registration requirements with the Food and Hospitality and Midwifery Board of Australia to practice as a Food and Hospitality.",
    },
    {
      question:
        "What is the cost of studying Food and Hospitality in Australia?",
      answer:
    ...
    {
      question:
        "Are there scholarships available for international Food and Hospitality students?",
      answer:
        "Yes, many Australian universities offer scholarships for international students. These can be merit-based, need-based, or specific to certain countries or fields of study like Food and Hospitality.",
    },
  ];
  ...
  return (
    <>
      ...
      {/* 2nd section - Food and Hospitality Content */}
      <div className="py-12 px-4 sm:px-6 lg:px-24 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="prose max-w-none text-gray-700">
            <p className="mb-4">
              Pursue Enrolled Food and Hospitality Courses in Australia from
              Bangladesh, from the urge of humanity & sense the spirit of
              rewards and individual fulfillment. With the chronic population
              boom worldwide, the demand for Food and Hospitality courses and
              proficient Food and Hospitalitys in the healthcare system is
              constantly rising.
            </p>
            <p className="mb-4">
              ...
              Food and Hospitality courses in Australia from Bangladesh may be
              the pertinent path for you. A diploma in Food and Hospitality
              courses at any globally ranked institute might allow you to
              kick-start your career as an enrolled Food and Hospitality.
            </p>
            <p className="mb-4">
              You can also study Food and Hospitality for an undergraduate or
              postgraduate degree, which will enable you to get a license and
              become a registered Food and Hospitality. Besides, considering
              Food and Hospitality as a career may entail a journey of
              healthcare benefits and work-hour flexibility.
            </p>
            <p className="mb-4">
              Moreover, the salary of this profession is also rising as demand
              for Food and Hospitality services soars. To get admission into
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Diploma of Food and Hospitality */}
              ...
              {/* Bachelor of Food and Hospitality */}
              <div className="border border-gray-200 p-5 bg-white rounded-lg shadow-sm">
                ...
                <ul className="text-gray-700 text-base list-disc list-inside space-y-2">
                  <li>
                    Education: Diploma of Food and Hospitality or Class 12th
                  </li>
                  <li>English Language: IELTS/PTE score 7 (on each band)</li>
                </ul>
              </div>

              {/* Master of Food and Hospitality */}
              <div className="border border-gray-200 p-5 bg-[#fff4f1] rounded-lg shadow-sm">
                <h3 className="text-lg font-semibold text-[#252364] mb-3">
                  Master of Food and Hospitality
                </h3>
      ...
      <div className="px-4 py-12 sm:px-6 lg:px-24 bg-[#fefefe]">
        <div className="max-w-7xl mx-auto">
          ...
          <ol className="list-decimal list-inside text-gray-700 space-y-1 text-base sm:text-lg">
            ...
            <li>Food and Hospitality Educator</li>
            <li>Food and Hospitality Researcher</li>
            <li>
              Registered Food and Hospitality (under a specific sub-field like
